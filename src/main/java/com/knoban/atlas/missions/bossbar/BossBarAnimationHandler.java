package com.knoban.atlas.missions.bossbar;
 ...
 * <br><br>
 * The intent of this class is to provide fluid, good looking UI mainly for the use of {@link Mission}s.
 *
 * @author Alden Bansemer (kNoAPP)
 */
public class BossBarAnimationHandler {

    private static final BossBarAnimationHandler DEFAULT = new BossBarAnimationHandler(Atlas.getInstance());
     ...
     */
    public BossBarAnimationHandler(Plugin plugin) {
        this.plugin = plugin;
    }
    ...
    public static BossBarAnimationHandler getDefaultBossBarAnimationHandler() {
        return DEFAULT;
    }
    ...
    private static class BossBarAnimation {
         ...
         */
        private void animate(Plugin plugin, long oldValue, long newValue, long maxValue) {
